const apiKey = '52fdaba92616cad4888f42d7f35c8911';
    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            for (const dayData of nextDaysData) {
                ...
                // Ensure the day isn't duplicated and isn't today
...
document.addEventListener('DOMContentLoaded', () => fetchWeatherData('Germany'));
